...
The `PipecatAppBase` component reduces the boilerplate code required to use the Pipecat Client SDK that typically remains the same across most applications.
...
This pattern gives you access to connection handlers and state, allowing you to build custom UI that responds to the connection state.
